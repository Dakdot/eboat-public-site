...
export const SupporterLink = ({
  ...
  return (
    <a
      ...
      target="_"
      className={`${href && "link"} transition-all px-4 py-6 sm:hover:scale-[105%] w-full sm:w-[500px] rounded-lg bg-white/10 border-white/30 backdrop-blur-md group shadow-lg`}
    >
